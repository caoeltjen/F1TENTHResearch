...
class ReactiveFollowGap(Node):
    def __init__(self):
        ...
        self.BUBBLE_RADIUS = 100                # indices around closest obstacle
        self.DISPARITY_THRESHOLD = 0.4          # adjacent range difference (m)
        ...
        self.CLEARANCE_MARGIN = 0.35             # m; min side clearance while turning
